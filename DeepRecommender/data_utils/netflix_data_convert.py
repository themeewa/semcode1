...
def create_Goodreads_data_timesplit(all_data,
                                  train_min,
                                  train_max,
                                  test_min,
                                  test_max):
  """
  Creates time-based split of Goodreads data into train, and (validation, test)
  :param all_data:
  :param train_min:
  :param train_max:
  :param test_min:
...
def main(args):
  ...
  for output_dir in [
    "Goodreads/NF_TRAIN", "Goodreads/NF_VALID", "Goodreads/NF_TEST"]:
